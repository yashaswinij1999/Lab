...
// C:/Users/yashu/Desktop/IO txt files/occurances.txt
...
public class Q6 {
    ...
    public static void main(String[] args) {
        ...
        replaceAllOcuurances(path, replaceWord, newWord);

    }

    public static void replaceAllOcuurances(String path, String replaceWord, String newWord) {
        ...
        if (f.exists() && f.isFile()) {
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    while ((pos = line.indexOf(replaceWord, pos)) != -1) {
